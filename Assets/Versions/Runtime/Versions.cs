...
namespace VEngine
{
    public static class Versions
    {
        ...
        public static Func<string, Type, Asset> FuncCreateAsset { get; set; } = BundledAsset.Create;
        public static Func<string, bool, Scene> FuncCreateScene { get; set; } = BundledScene.Create;
        public static Func<string, bool, ManifestAsset> FuncCreateManifest { get; set; } = ManifestAsset.Create;
